...
public class SteganographyExt extends SimpleProgram implements SteganographyConstants {
    ...
    public class SteganographyFileFilter extends FileFilter {
        // $FF: synthetic field
        final SteganographyExt this$0;
        // $FF: synthetic field
        private final String[] val$extensions;
        // $FF: synthetic field
        private final String val$description;

        SteganographyFileFilter(SteganographyExt var1, String[] var2, String var3) {
            this.this$0 = var1;
        ...
        public boolean accept(File filename) {
            return filename.isDirectory() || Arrays.asList(this.val$extensions).contains(SteganographyExt.access$0(this.this$0, filename));
        }
    ...
    private void hideMessage() {
        try {
            GImage e = SteganographyLogicExt.hideMessage(this.toBooleanArray(this.getImage(this.drawing)), this.getImage(this.picture));
            if (e == null) {
    ...
    private void recoverMessage() {
        try {
            this.drawing.setImage(this.toGImage(SteganographyLogicExt.findMessage(this.getImage(this.picture))));
    ...
    private GImage toGImage(boolean[][] pixels) {
        int[][] pic = this.picture.getImage().getPixelArray();
        if (pixels == null) {
            ...
            for (int row = 0; row < pixels.length; ++row) {
                for (int col = 0; col < pixels[row].length; ++col) {
                    int red = GImage.getRed(pic[row][col]);
                    int green = GImage.getGreen(pic[row][col]);
                    int blue = GImage.getBlue(pic[row][col]);
                    if (pixels[row][col]) {
                        if ((red % 2 == 0) && (green % 2 == 0) && (blue % 2 == 0))
                            var5[row][col] = GImage.createRGBPixel(0, 0, 0);
                        else var5[row][col] = GImage.createRGBPixel(255, 255, 255);

                    } else {
                        if ((red % 2 == 0) && (green % 2 != 0) && (blue % 2 != 0))
                            var5[row][col] = GImage.createRGBPixel(255, 0, 0);
                        if ((red % 2 == 0) && (green % 2 == 0) && (blue % 2 != 0))
                            var5[row][col] = GImage.createRGBPixel(255, 255, 0);
                        if ((red % 2 != 0) && (green % 2 == 0) && (blue % 2 != 0))
                            var5[row][col] = GImage.createRGBPixel(0, 255, 0);
                        if ((red % 2 != 0) && (green % 2 == 0) && (blue % 2 == 0))
                            var5[row][col] = GImage.createRGBPixel(0, 255, 255);
                        if ((red % 2 != 0) && (green % 2 != 0) && (blue % 2 == 0))
                            var5[row][col] = GImage.createRGBPixel(0, 0, 255);
                        if ((red % 2 == 0) && (green % 2 != 0) && (blue % 2 == 0))
                            var5[row][col] = GImage.createRGBPixel(255, 0, 255);
                    }
                }
            }
    ...
    // $FF: synthetic method
    static String access$0(SteganographyExt var0, File var1) {
